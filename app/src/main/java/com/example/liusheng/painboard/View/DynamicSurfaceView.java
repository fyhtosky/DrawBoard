...
public class DynamicSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static Integer[] BITMAP_SHADERS = {
            R.drawable.p_shader,R.drawable.p_shader_2,
            R.drawable.p_shader_3, R.drawable.p_shader_25, R.drawable.p_shader_26, R.drawable.p_shader_5,
            ...
            R.drawable.p_shader_27, R.drawable.p_shader_28, R.drawable.p_shader_0,
            R.drawable.p_shader_1, R.drawable.p_shader_4,
    };
